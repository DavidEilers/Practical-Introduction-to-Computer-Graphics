...
void SetLights ()
{
	...
	// Licht 0
	cg_light l ( 0 );
	l.setPosition( -20.0f, -20.0f, 5.0f, 0.0f ); // paralles Licht
//	l.setPosition( -5.0f, 5.0f, 5.0f, 1.0f ); // Punktlicht
	l.setAmbient( 0.5f, 0.5f, 0.5f, 0.0f );
	l.setDiffuse( 0.3f, 0.3f, 0.3f, 1.0f );
	l.setSpecular( 0.5f, 0.5f, 0.5f, 1.0f );
	l.setSpotlight( 0.0f, 0.0f, 0.0f, 180.0f, 0.0f );
	l.setAttentuation( 1.0f, 5.0f, 2.0f );
	//l.enable();
	l.draw();
}
